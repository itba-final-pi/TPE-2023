...
{
#ifdef MON
    char *stations_path = "./Datasets Alumnos SMALL/stationsMON.csv";
    char *trips_path = "./Datasets Alumnos/Mas/emptyBikesMON.csv";
...
#ifdef NYC
    char *stations_path = "./Datasets Alumnos SMALL/stationsNYC.csv";
    char *trips_path = "./Datasets Alumnos/Mas/emptyBikesNYC.csv";
